...
docs-check:
	...
	@powershell -NoProfile -Command "if (!(Test-Path 'docs/local-dev/09_FULL_PROJECT_TEST_PLAN.md')) { exit 1 }"
	@powershell -NoProfile -Command "if (!(Test-Path 'docs/local-dev/10_DOCKER_COMPOSE_HANDHOLDING.md')) { exit 1 }"
