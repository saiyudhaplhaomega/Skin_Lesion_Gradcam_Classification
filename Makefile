...
docs-check:
	...
	@powershell -NoProfile -Command "if (!(Test-Path 'docs/product/04A_SAFE_LLM_EXPLANATION_HANDHOLDING.md')) { exit 1 }"
	@powershell -NoProfile -Command "if (!(Test-Path 'docs/product/04B_LANGCHAIN_ADK_OBSERVABILITY_HANDHOLDING.md')) { exit 1 }"
	...
	@powershell -NoProfile -Command "if (!(Test-Path 'docs/product/SEO_AND_PUBLIC_PAGES_HANDHOLDING.md')) { exit 1 }"
	...
	@powershell -NoProfile -Command "if (!(Test-Path 'docs/product/14_LLM_RAG_AGENT_BOUNDARIES_HANDHOLDING.md')) { exit 1 }"
	@powershell -NoProfile -Command "if (!(Test-Path 'docs/product/15_ADMIN_MARKET_RESEARCH_RAG_HANDHOLDING.md')) { exit 1 }"
	@powershell -NoProfile -Command "if (!(Test-Path 'docs/product/16_ROLE_BASED_EVOLVING_AGENTS_HANDHOLDING.md')) { exit 1 }"
