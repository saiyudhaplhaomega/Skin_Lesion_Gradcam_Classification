...
```text
docs/staging/13_TERRAFORM_PARAMETERS_AND_BOOTSTRAP_HANDHOLDING.md
docs/staging/00_CLOUD_COST_CONTROL_HANDHOLDING.md
docs/staging/14_TERRAFORM_STORAGE_SECRETS_AND_ECR_HANDHOLDING.md
docs/staging/15_TERRAFORM_DATABASE_AND_EVENTS_HANDHOLDING.md
docs/staging/16_TERRAFORM_SECURITY_OBSERVABILITY_HANDHOLDING.md
docs/staging/17_EKS_INGRESS_ALB_CONTROLLER_HANDHOLDING.md
